...
int main() {
    ...
    // Needed for rendering points for vertices
    // Requires a vertex shader file using GLSL
    ...
    // Needed for rendering colors for each points of verticies
    // Requires a fragment shader file using GLSL
